...
```bash
clone-gd-addon https://github.com/ChillCube/InventoryManagerGrid.git
```

## Documentation
You can find the documentation at: https://github.com/ChillCube/InventoryManagerGrid/blob/main/DOCUMENTATION.md

## Deinstallation
### Linux
Run this in the root of your godot project:
```bash
remove-gd-addon InventoryManagerGrid
```
